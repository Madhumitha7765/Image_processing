...
% Last Modified by GUIDE v2.5 18-Mar-2021 18:12:46
...
% --- Executes on button press in imagefusion.
function imagefusion_Callback(hObject, eventdata, handles)
% hObject    handle to imagefusion (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
run('imfusion.m')
